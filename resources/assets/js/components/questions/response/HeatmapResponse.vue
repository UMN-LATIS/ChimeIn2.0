<template>
    <div>
        <div class="col-sm-12">
            ...
            <img ref="targetImage" data-cy="image-heatmap-target" class="img-fluid max-height-image" v-bind:src="'/storage/' + question.question_info.question_responses.image" @click="triggerResponse" @load="updateScaledCoordinates">
        </div>
         <div class="col-sm-12">
...
export default {
    ...
    methods: {
        updateScaledCoordinates: function() {
            ...
            var px=this.response.response_info.image_coordinates.coordinate_x * cw/iw;
            var py=this.response.response_info.image_coordinates.coordinate_y * ch/ih;
    ...
    mounted() {
        if(this.response && this.response.hasOwnProperty('response_info') && this.response.response_info.hasOwnProperty('image_coordinates')) {
            this.updateScaledCoordinates();
        }
    }
};
