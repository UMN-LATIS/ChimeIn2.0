...
export default {
    ...
    computed: {
        ...
        chartData: function () {
            var questionArray = this.question.question_info.question_responses.map(q => { return [q, this.responses.filter(r => q === r.response_info.choice).length, 'color: rgb(54, 162, 235); opacity: 0.4; stroke-opacity: 0.9; stroke-width: 2'] })
