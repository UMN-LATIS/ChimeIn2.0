<template>  
    <div>
        <div class="row form-group">
                <label for="left_choice_text" class="col-form-label col-sm-2">Left Label: </label>
        ...
        <div class="row form-group">
                <label for="right_choice_text" class="col-form-label col-sm-2">Right Label:</label>
                <div class="input-group col-sm-10">
                    <input
         ...
         <div class="row form-group">
                <label for="right_choice_text" class="col-form-label col-sm-2">Range Type:</label>
                <div class="input-group col-sm-10">
                    <select id="range_type" v-model="range_type" @change="emitChanges" class="form-control" :disabled="range_disabled">
