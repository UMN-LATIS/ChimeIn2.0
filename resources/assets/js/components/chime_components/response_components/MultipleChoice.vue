<template>
  <div>
      ...
      <div class="col">
        ...
        <ol type="A" data-cy="response-choice-list">
          <draggable :list="question_responses">
            <li v-for="(r, i) in question_responses" :key="i">
              <div class="row">
                ...
                <div class="col-1">
                  <i
                    ...
                    v-if="isObject(r) ? r.correct : false"
                    >check</i
                  >
                </div>
                <div class="col-2">
    ...
    <div class="row" v-if="!truefalse || editing_index !== null">
      <div class="col">
        <label for="choice_text" class="form-control-label"
          >Add a response
          <small id="emailHelp" class="form-text text-muted"
            >Optionally use the checkbox to mark correct responses.</small
          ></label
        >
        ...
        <div class="input-group">
          <div class="input-group-prepend">
            <div class="input-group-text">
              <input
                data-cy="response-is-correct-checkbox"
                type="checkbox"
                v-model="choice_correct"
  ...
  methods: {
    ...
    add_choice: function() {
      if (this.editing_index !== null) {
        this.$set(this.question_responses, this.editing_index, {
          text: this.choice_text,
          correct: this.choice_correct,
        });
      } else {
        this.question_responses.push({
          text: this.choice_text,
          correct: this.choice_correct,
        });
      }
    ...
    isTrueFalse: function() {
      if (
        ...
        JSON.stringify(this.question_responses.map((e) => e.text)) ==
